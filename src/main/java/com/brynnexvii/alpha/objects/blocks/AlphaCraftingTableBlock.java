...
public class AlphaCraftingTableBlock extends CraftingTableBlock{
	
	private static final ITextComponent field_220271_a = new TranslationTextComponent("container.crafting");
	
	public AlphaCraftingTableBlock(Properties properties) {
		super(properties);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player,
		...
		Alpha.LOGGER.info("Crafting table fired");
		if (worldIn.isRemote) {
	...
	public INamedContainerProvider getContainer(BlockState state, World worldIn, BlockPos pos) {
		...
		Alpha.LOGGER.info("Crafting table 2 fired");
